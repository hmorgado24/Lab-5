...
stats = {'subangle':sangle, 'zangle':zangle, 'angle':s1}
with open('stpstor.txt', 'w') as f:
  json.dump(stats, f)
...
print('<input type="range" name="angle" min ="0" max="360" value ="0"> <br>')
print('<input type="submit" name="subangle" value="Angle Input"> <br> <br>')
